...
const categories = [
  { icon: Landmark, label: "Land", count: 12, type: "land" },
  { icon: Home, label: "Residential", count: 34, type: "residential" },
  { icon: Building2, label: "Commercial", count: 18, type: "commercial" },
  { icon: Factory, label: "Industrial", count: 8, type: "industrial" },
];
